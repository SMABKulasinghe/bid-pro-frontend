...
<div class="col-md-12 col-lg-12 animated fadeInLeft">
	<div class="box box-default">
		...
		<div class="box box-info">
			<div class="box-header with-border">
				<h4 class="card-subtitle">Payment Authorization</h4>
			</div>
			<div class="">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="box-body">
						<fieldset>
					<h5 class="">Find Payment Information for a Supplier</h5>
	...
	<div class="box box-info animated fadeInDownBig" id="userTableDiv">
		<div class="box-header with-border">
			<h4 class="card-subtitle">Payments to be Authorize</h4>
		</div>

		<div class="row">
			<div class="col-md-12">
				<div class="box-body">
					<table id="paymentAuthTbl"
...
<script src="resources/assets/vendor_plugins/DataTables-1.10.15/extensions/Buttons/js/buttons.print.min.js"></script>
 ...
 <script src="resources/js/customjs/payment/paymentapprove.js"></script>




<script type="text/javascript">
	$('#titleID').text("Payment Approval");
	$('#bcumb').text("Payment Approval");
</script>
								...
								<fieldset>
									<form class="forms-sample">
										...
										<fieldset>
											...
											<div class="form-group">
												<label for="acceptTerms">Upload Excel File</label> <br>
												<input type="file" name="file" id="POU_headerUp_input1"
													class="hide">
											</div>
											<div class="form-group">
												<label for="acceptTerms">Upload Scan File</label> <br>
												<input type="file" name="file" id="POU_headerUp_input2"
													class="hide">
											</div>
										</fieldset>
