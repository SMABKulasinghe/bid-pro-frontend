    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="image">
          ...
          <img id="company_logo_img" src="resources/images/custom/default_login.png" onerror="if (this.src != 'resources/images/custom/default_login.png') this.src = 'resources/images/custom/default_login.png';" class="rounded-circle" alt="company_logo">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- <li class="menu-open treeview" id="companyprofile" onclick="navigate('qrcodescanner')">
          <a href="#">
            <i class="fa fa-pie-chart"></i> <span>QR Code Scanner</span>            
          </a>       
        </li> -->
        ...
        <li class="treeview" id="rfpMainItem">
         ...
         <li class="header" style="color: #1e88e5;">Technical Evaluation</li>
        ...
        <li class="treeview" id="procurementComMainItem">
         ...
         <li class="header" style="color: #1e88e5;">Purchase Order (PO)</li>
