 <div class="col-xl-12 col-lg-8 animated fadeInLeftBig">
	...
	<div class="box box-info animated fadeInLeft" id="blockTableDiv">
		<div class="box-header with-border">
			<h4 class="card-subtitle text-green">View Block Suppliers</h4>
		</div>

		<div class="row">
			<div class="col-md-12">
				<div class="box-body">
					<table id="tbl_viewBlock_supplier"
...
<div id="mdl_view_block_sup" class="modal fade bd-example-modal-lg" role="dialog">
...
<div id="view_block_Modal" class="modal fade bd-example-modal-lg" role="dialog">
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="media">
						<div class="col-md-12">
							<div class="box-body">
								<table id="view_block_category_sup"
									class="table table-bordered table-hover display nowrap margin-top-10 table-responsive">
									<thead>
										<tr class="text-yellow">
											<th>Index</th>
...
<!-- Modal for Unblock Supplier -->
<div id="ml_supplierUnblock_Modal" class="modal fade bd-example-modal-lg" role="dialog">
		<div class="modal-dialog modal-lg">
			...
			<div class="modal-content">
				    ...
				    <div style="width: 100%;">
				       ...
				       <div class="col-md-2">
						...
						<div class="col-md-10">
							<div class="row">
								<div class="col-md-12">
									<h1 class="modal-title pull-right" id="mdl_ar_com_name">Supplier Unblock</h1>
								</div>
							</div>
					...
					<div class="media">
						<div class="col-md-10">
							...
							<div class="form-group">
								<label for="unblock_reason">Reason <span style="color: red">*</span></label>
								<textarea id="reason_unblocksupplier" class="form-control" rows="3" ></textarea>
						 </div>
							</div>
						</div>
					</div>					
				...
				<button type="button" style="margin : 5px" id="unblock_button" class="btn btn-primary pull-right" data-dismiss="modal">Unblock</button>&nbsp; &nbsp;</div>
			</div> 
		</div>
</div> 
...
<script type="text/javascript">
	$('#titleID').text("View Block Suppliers");
	$('#bcumb').text("View Block Suppliers");
</script>


 <script src="resources/js/customjs/supplier/viewblocksuppliers.js"></script>
