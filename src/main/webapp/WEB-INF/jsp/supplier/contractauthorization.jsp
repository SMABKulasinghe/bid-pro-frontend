...
<div class="col-xl-12 col-lg-8 animated fadeInLeft">
	...
	<div class="box box-info">
		<div class="box-header with-border">
			<h4 class="card-subtitle">Pending Authorization</h4>
		</div>
		<div class="">
...
<!-- 
				...
				<div class="box-body">
					<fieldset>
						...
						<div style="margin-top: 40px" class="form-group row">
							...
							<div class="col-sm-6">
									<select class="form-control m-b" name="contract_id"
										id="contract_id" required="required">
									</select>
							</div>
						...
						<div style="margin-top: 40px" class="form-group row">
							<div class="col-sm-12">
								<div class="checkbox">
									...
									<label for="acceptTerms">Select to show all pending authorization</label>
								</div>
							</div>
						</div>
					</fieldset>
	...
	<!-- /.User List table -->
	<div class="box box-info animated fadeInDownBig" id="contractTableDiv">
		<div class="box-header with-border">
			<h4 class="card-subtitle">Contract to be Authorize</h4>
		</div>
...
<script type="text/javascript">
	...
	$('#titleID').text("Authorize Contract");
	$('#bcumb').text("Pending Authorization");
...
<!-- <script src="resources/js/pages/data-table.js"></script> -->
 ...
 <script src="resources/js/customjs/contract/contractauthorization.js"></script>
