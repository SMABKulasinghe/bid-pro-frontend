 <div class="col-xl-12 col-lg-8 animated fadeInLeftBig">
	...
	<div class="box box-info animated fadeInLeft" id="userTableDiv">
		<div class="box-header with-border">
			<h4 class="card-subtitle text-green">View Suppliers</h4>
		</div>

		<div class="row">
			<div class="col-md-12">
				<div class="box-body">
					<table id="tbl_supplier_view"
...
<div id="mdl_view_sup" class="modal fade bd-example-modal-lg"
	role="dialog">
...
<script type="text/javascript">
	...
	$('#titleID').text("View Suppliers");
	$('#bcumb').text("View Suppliers");

</script>

 <!-- <script src="resources/js/customjs/supplier/supplierauthorization.js"></script> -->
 <script src="resources/js/customjs/supplier/viewsuppliers.js"></script>
