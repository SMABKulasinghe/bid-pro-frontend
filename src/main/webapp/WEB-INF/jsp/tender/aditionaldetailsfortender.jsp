...
<div class="col-md-12 col-lg-12 animated fadeInLeft">
	...
	<div class="box box-default">
		...
		<div class="box box-info">
			<div class="box-header with-border">
				<h3 class="box-title text-green">Make additional file per Tender</h3>
			</div>
			<!-- /.box-header -->
			<!-- form start -->
			<div class="box-body">
					...
					<fieldset>
						...
						<div class="form-group row">
							...
							<div class="col-sm-8" id="tenderIdDiv">
								<select id="tender_id_for_aditional_details" name="tender_id_for_aditional_details"
									 	class="form-control select2" value="" required="required"> </select>
							</div>
						</div>
						
						<h5 class="text-green">Set a File Name</h5>
	...
	<div class="box box-default">
		...
		<div class="box box-info">
			<div class="box-header with-border">
				<h3 class="box-title text-green">Unlock to modified additional files</h3>
			</div>
			
				<h5 class="box-title">Once the file is uploaded this parameter will be locked and file will be assigned for this tender
To change the file or the parameter name, it should be unlocked from Additional Files for Tender</h5>
				...
				<div class="col-md-6">
					...
					<fieldset>
						...
						<div class="form-group row">
							<label for="inputPassword3" class="col-sm-4 control-label">Select Tender No *</label>
							<div class="col-sm-8" id="tenderIdDiv">
								<select id="tender_id_for_aditional_details_4" name="tender_id_for_aditional_details_4"
									 	class="form-control select2" value="" required="required"> </select>
							</div>
						</div>
					</fieldset>
			...
			<fieldset class="col-md-12">
				...
				<div class="box-footer">
					<!-- <button type="submit" class="btn btn-default">Cancel</button> -->
					<button type="submit" id="submit_button_lock_additional_files" class="btn btn-info pull-right">Submit</button>
				</div>
...
<script src="resources/js/customjs/tender/aditionaldetailsfortender.js"></script>
