...
<div class="col-xl-12 col-lg-8 animated fadeInLeft">
	...
	<div class="box box-info">
		<div class="box-header with-border">
			<h4 class="card-subtitle">Invoice Authorization</h4>
		</div>
		<div class="">
						...
						<div style="margin-top: 40px" class="form-group row">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="user_ID"
									name="user_ID" placeholder="Invoice No" autocomplete="off" disabled>
							</div>
							<div class="col-sm-4">
								<button type="submit" id="searchUserIDButton"
								class="btn btn-info pull-right" disabled>SUBMIT</button>
							</div>
						...
						<div style="margin-top: 40px" class="form-group row">
							<div class="col-sm-12">
								<div class="checkbox">
									...
									<label for="acceptTerms" style="color: cyan;">Select to show all pending invoice authorization(s)</label>
								</div>
							</div>
						</div>
					</fieldset>
	...
	<div class="box box-info"  id="contractTableDiv">
		<div class="box-header with-border">
			<h4 class="card-subtitle">Invoices to be Authorize</h4>
		</div>
		<fieldset>
						<!-- <div class="col-md-2">
				<div class="box-body">
			...
			<!-- <div>
				<button type="button" id="tableRefreshButton" class="btn btn-default"><i class="fa fa-spin fa-refresh"></i> </button>
			</div> -->
		</fieldset>
...
<script type="text/javascript">
	...
	$('#titleID').text("Invoice Approval");
	$('#bcumb').text("Invoice Authorization");
...
<script src="resources/assets/vendor_plugins/DataTables-1.10.15/extensions/Buttons/js/buttons.print.min.js"></script>
 ...
 <script src="resources/js/customjs/invoice/invoiceapprove.js"></script>
