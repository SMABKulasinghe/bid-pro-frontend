...
<div class="col-xl-12 col-lg-8 animated fadeInLeft">
	...
	<div class="box box-info">
		<div class="box-header with-border">
			<h3 class="box-title">PO Authorization</h3>
		</div>
		<!-- /.box-header -->
		<!-- form start -->
		<div class="box-body">
...
<script type="text/javascript">
	$('#titleID').text("PO Authorization");
	$('#bcumb').text("PO Authorization");
</script>
<script src="resources/js/customjs/purchaseorder/poauthorization.js"></script>
