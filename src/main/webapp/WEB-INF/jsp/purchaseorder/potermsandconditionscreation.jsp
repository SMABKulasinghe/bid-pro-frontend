...
<div class="col-md-12 col-lg-12 animated fadeInLeft">
	<div class="box box-default">
		...
		<div class="box box-info">
			<div class="box-header with-border">
				<h3 class="box-title text-green">Create Terms and Conditions</h3>
			</div>
			<!-- /.box-header -->
			<!-- form start -->
			<div class="box-body">
				...
				<div class="col-md-6">
					...
					<fieldset>
						...
						<div class="form-group row">
							<label for="inputPassword3" class="col-sm-4 control-label">Criteria *</label>
							<div class="col-sm-8">
								<input id="terms_and_conditions" name="terms_and_conditions"
	...
	<div class="box box-info">
		<div class="box-header with-border">
			<h3 class="box-title text-green">View Terms and Conditions</h3>
		</div>
		<!-- /.box-header -->
		<!-- form start -->
		<div class="box-body">
		<div class="row">
			<div class="col-md-12" id="trmsAndConTbleDiv">
				<table id="trms_and_con_table" class="table table-bordered table-hover display nowrap margin-top-10 table-responsive dataTable no-footer dt-checkboxes-select">
				<thead>
					<tr class="text-green">
						<th>Index</th>
...
<script type="text/javascript">
	...
	$('#titleID').text("Terms and Conditions for PO");
	$('#bcumb').text("Terms and Conditions for PO");
...
<script src="resources/js/customjs/purchaseorder/potermsandconditionscreation.js"></script>
