...
<div class="col-xl-12 col-lg-8 animated fadeInLeft">
	...
	<div class="box box-info">
		<div class="box-header with-border">
			<h3 class="box-title text-green">Create a committee for RFP</h3>
		</div>
		<!-- /.box-header -->
		<!-- form start -->
		<div class="box-body">
...
<script type="text/javascript">
	$('#titleID').text("RFP Evaluation Committee Creation");
	$('#bcumb').text("RFP Evaluation Committee Creation");
//	document.getElementById("submit_button").disabled = false;
</script>


</script>
<script src="resources/js/customjs/rfpevaluation/rfpevaluationcommitteecreation.js"></script>