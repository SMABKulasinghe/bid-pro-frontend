	...
	<div class="box box-default">
		...
		<div class="box box-info">
			<div class="box-header with-border">
				<h4 class="card-subtitle text-green">Update  RFP</h4>
			</div>
			<div class="">
...
<script src="resources/js/customjs/rfp/updaterfp.js"></script>
...
<script type="text/javascript">
	$('#titleID').text("Update RFP");
	$('#bcumb').text("Update RFP");
</script>
