<div class="col-md-12 col-lg-12 animated fadeInLeft">
	...
	<div class="box box-info animated fadeInDownBig" id="userTableDiv">
		<div class="box-header with-border">
			<h4 class="card-subtitle">Upload Request Documents </h4>
		</div>
<br/>
		<div class="box-body">
			<div class="row">
				...
				<div class="col-md-6">
					 ...
					 <fieldset>
			<!-- 	<h5 class=" ">Company Request Upload Files</h5>  -->
					<div class="form-group row">
						<label for="inputPassword3" class="col-sm-4 control-label">Upload Doc 1 *</label>
						<div class="col-sm-8">
	...
	<div class="col-md-6">
				...
				<!-- <h5 class=" ">Company Request Upload Files</h5>  -->
					<div class="form-group row">
						<label for="inputPassword3" class="col-sm-4 control-label">Upload Doc 2 *</label>
						<div class="col-sm-8">
							<label title="Upload image file" for="inputImage"
								class="btn bg-olive"> <input type="file"
								accept="image/*" name="file" id="upload_rpf" class="btn btn-block  bg-olive btn-lg">
...
<script type="text/javascript">
	$('#titleID').text("Upload Files");
	$('#bcumb').text("Upload Files");
</script>
