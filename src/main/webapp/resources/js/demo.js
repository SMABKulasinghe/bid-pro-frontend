...
//  )
  ...
  var $skinAsh =
        $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-ash" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
            + '<div><span style="display:block; width: 20%; float: left; height: 7px; background: #414141" ></span><span style="display:block; width: 80%; float: left; height: 7px; background: #919191"></span></div>'
            + '<div><span style="display:block; width: 20%; float: left; height: 20px; background: #272c33"></span><span style="display:block; width: 80%; float: left; height: 20px; background:  #383f48"></span></div>'
            + '</a>'
            + '<p class="text-center no-margin">Ash</p>')
  $skinsList.append($skinAsh)
