...
$(document).ready(function() {
	...
	if (tbl_company_auth == undefined) {
		tbl_company_auth = $('#tbl_company_auth').DataTable({
			 ...
			 responsive: true,
		     ajax: {
		    	 url:globalUrl+"/supplier/authcompany",
		         type: 'GET',
		...
		tbl_company_auth.ajax.url(globalUrl+"/supplier/authcompany" ).load();
	}
});
	...
	Swal.fire({
		  ...
		  confirmButtonText: 'Yes, Approve!'
			  ...
			  if (result.value) {
				  ...
				  getAsyncData("/supplier/"+id+"/approve", function(res) {
	...
	Swal.fire({
		  ...
		  confirmButtonText: 'Yes, Reject!'
			  ...
			  if (result.value) {
				  ...
				  getAsyncData("/supplier/"+id+"/auth/reject", function(res) {
					  tbl_company_auth.ajax.url(globalUrl+"/supplier/auth" ).load();
					  Swal.fire(
						      'Removed!',
